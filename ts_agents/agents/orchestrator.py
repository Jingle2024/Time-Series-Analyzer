        ...
        **kwargs,
        ...
        series_results = self._run_series_analysis(
            ...
            pipeline_warnings=pipeline_warnings,
                        flann_variant=flann_variant,
            flann_basis=flann_basis,
            flann_order=flann_order,
            flann_ridge_lambda=flann_ridge_lambda,
            flann_recurrent_depth=flann_recurrent_depth,
            rvfl_n_hidden=rvfl_n_hidden,
            rvfl_activation=rvfl_activation,
            run_all_flann_variants=run_all_flann_variants,
        )
